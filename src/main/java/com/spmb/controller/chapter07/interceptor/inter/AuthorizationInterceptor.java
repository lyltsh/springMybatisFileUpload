package com.spmb.controller.chapter07.interceptor.inter;
...
/**
 * @Description: 拦截器，必须实现HandlerInterceptor接口
 * @Author: leiyulin
 * @date: 2018/6/9
 */
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!flag) {
            ...
            if (null == user) {
                ...
                request.getRequestDispatcher(PREFIX + "loginForm").forward(request, response);
            } else {
                // 如果用户已经登录，则验证通过，放行
